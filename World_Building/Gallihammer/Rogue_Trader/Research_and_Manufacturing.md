...
- Replacement parts for common weapons
- Basic rations, drugs, and consumables
...
### Tier 3 — Experimental
One-off or limited-run items produced from rare or irreplaceable components. Cannot be mass-produced. Often more capable than anything in regular production, and lost or consumed if destroyed.

*Unlocked through: significant pre-collapse finds, unique salvage, rare xeno specimens, major arcane discoveries, Damien's more ambitious projects.*

---

## Research Branches

The programme operates across four distinct branches, each requiring different expertise, facilities, and source material. Multiple branches can run concurrently, limited by personnel capacity and Damien's attention.

### Technical
The foundational branch — weapons, armour, equipment, vehicles, power systems. Analysis of looted or salvaged technology to understand construction and reproduce or improve it. The most straightforward branch operationally, though pre-collapse imperial tech remains only partially comprehensible.

*Sources: looted enemy gear, salvaged wreckage, purchased schematics, pre-collapse archives*
*Lead: Damien, enginseer staff*
...
### Xenological
Study of non-human technology, biology, and culture. The least predictable branch — xeno systems frequently operate on principles that don't map cleanly to human engineering or biological frameworks, and partial understanding can produce unexpected results. Outcomes range from highly effective alien power sources and weapons to items that work in ways nobody fully intended.

*Sources: xeno equipment and specimens acquired through combat, trade, or salvage*
*Lead: Damien (forbidden lore: xenotech)*
*Outputs: adapted xeno weapons and equipment, alien power sources, biological compounds derived from xeno specimens, intelligence on xeno factions and physiology*

### Arcane
The most sensitive branch, running quietly alongside the others. Ritual development, warp phenomenon analysis, psychic focus item construction, and the study of occult texts and artefacts recovered in the field. Draws on the Navigator's knowledge, the daemonologists, and Damien's growing occult documentation archive. Results in this branch are less predictable than any other and occasionally produce outcomes that were not the intended research goal.

*Sources: recovered occult texts, warp-adjacent artefacts, Navigator consultation, daemonologist expertise, field observation of psychic phenomena*
*Lead: Damien (documentation and analysis), Navigator and daemonologists (practical expertise)*
*Outputs: new rituals, psychic focus items, warp-resistant materials, improved transit observances, containment protocols for warp entities, arcane augmentations*

*Note: Arcane research findings are stored separately from the main archive, access restricted to senior crew.*
...
### Acquisition
Research begins with something to study — a looted weapon, a recovered system, a captured piece of technology, a xeno specimen, an arcane text, a fragment of pre-collapse documentation. The more intact or complete the source material, the more can be learned from it.
...
Everything beyond this was earned — looted, researched, or manufactured through the programme.
...
**Cross-branch potential:** The most significant breakthroughs often come from unexpected intersections — a xeno power source applied to a technical problem, a biological compound that responds to arcane treatment, an imperial archive that sheds light on a ritual the daemonologists have been attempting to reconstruct. Damien tracks cross-branch possibilities actively.

**Arcane research risks:** Unlike the other branches, arcane research carries the possibility of attracting attention from things that notice when someone is paying attention to them. The daemonologists manage this risk. So far, successfully.