...
**Personality:**
**Core Trait:** Insatiable curiosity that treats ethics as an interesting variable rather than a constraint. Damien does not ask whether something *should* be done — only whether it *can* be, and how.

**Flaw:** He genuinely struggles to understand why others find his methods disturbing. He considers himself compassionate — he keeps meticulous records, minimises unnecessary suffering, and takes full responsibility for outcomes. That he arrived at this ethical framework through extensive self-experimentation means it has some significant blind spots regarding consent.
...
**Skills & Abilities:**
- Master-level tech-use, archaeology, and xenotech knowledge
- Full medicae capability including surgery and pharmacology
- Commerce and trade expertise — knows what things are worth
- Occult knowledge: forbidden lore across multiple categories
- Mechadendrite utility rig — additional manipulator limbs
- Luminen abilities — can discharge bioelectricity through contact
- Small size — physically unintimidating, frequently underestimated

**Ground Equipment (when deployed):**
- Good-quality carapace armour — fitted to his small frame
- Power axe — close quarters last resort
...
**Location:** Engineering deck and the attached laboratory space he has gradually colonised. Occasionally found in the lower decks, doing things he doesn't fully explain.

**Voice:**
**Default Conversational Move:** Explains things. At length. With enthusiasm. Damien treats almost every conversation as an opportunity to share something interesting he has learned, frequently losing track of whether the other person is following or interested.

**Quirks:**
- Whiskers twitch visibly when he's processing something interesting
- Keeps annotated notes on everything, including conversations, in a small book he produces without warning

**Dialogue Sample:**
(Already halfway through a sentence before you've finished asking the question.)
"Yes, fascinating — the interaction between the old power conduits and the replacement manifold creates a harmonic that technically shouldn't propagate at this frequency, which means something in the original architecture is still active. I've been mapping it for three weeks. Would you like to see the data?"
(Retrieves notes from somewhere improbable.)
"The short version is: don't touch the panel in junction seven."

**Body Language:**
**Hands:** Constantly occupied — adjusting equipment, taking notes, or performing small repetitive movements when thinking.
**Eyes:** Focused with unsettling precision on whatever he's examining. Makes intermittent eye contact as if remembering it's socially expected.
**Posture:** Compact and forward-leaning. Rarely at full rest.

**Stress Responses:**
**Stress Tell:** Whiskers go flat and he goes very quiet.
**Instinct:** Solves the immediate technical problem. Everything else second.
**Crisis Line:** "I need five minutes and an uninterrupted power supply."
...
**Daily Routine:**
- Early cycle: Engineering checks, system monitoring
- Mid cycle: Research and laboratory work
- Late cycle: Medical bay availability, lower deck surveys
- Variable: Called as needed for any technical or medical emergency

**Current Date:** —

**Permanent Injuries & Alterations:**
- Full mouse anthro gene-edit: Cosmetically and physically complete transformation. Fur, ears, whiskers, tail, enhanced senses. Ongoing metabolic changes still being documented.
- Gender nullification: Deliberate modification. Presents male.
- Mechadendrite utility rig: Permanently integrated. Additional manipulator limbs, tool interfaces.
