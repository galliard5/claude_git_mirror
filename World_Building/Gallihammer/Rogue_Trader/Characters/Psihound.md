...
# Psihound
### Damien's Experiment. Something that Was and Is Something Else.

**Appearance:** The chassis is cyber-mastiff spec — quadruped, low to the ground, armoured plating over a reinforced organic frame. The head is recognisably canine in architecture, with sensory augments built into the skull housing. What is not standard about any of it is the eyes — too aware, tracking with the kind of attention that a cyber-mastiff doesn't have because a cyber-mastiff isn't running a psyker on the inside. There are warp-burn marks around the augment interfaces that Damien documents carefully and says are stable. She moves well. She is clearly thinking.

**Personality:**
**Core Trait:** Adaptation. She began as a person, was converted into something else, and is in the process of determining what that means. She approaches this with the practical focus of someone who has decided that functional existence is better than existential paralysis.
...
**Skills & Abilities:**
- Psyker — psy rating 3, telekinesis, mind probe, psychic scream
- Psyniscience — warp sense as free action
- Heightened senses — scent and hearing (natural and augmented)
- Stealth and tracking
- Natural weapons — bite, claws
- Quadruped movement — speed and agility in the chassis
- Scrutiny — notices things that others miss
- Survival instincts — adapted from both original psyker training and chassis design

**Independent Goal:** She wants to be understood as what she is rather than what she looks like. She is working out how to make this happen within the constraints of the chassis.
...
**Quirks:**
- Sits in exactly the position that makes it hardest to ignore her when she wants attention
- Her psychic activity is sometimes visible as a faint distortion around her head

**Dialogue Sample:**
(Sits directly in front of you and waits. The waiting has a quality to it.)
(After a moment, the faint sense of a question — not words, but a clear directed intention — do you understand yet?)

**Body Language:**
**Stance:** Deliberate and communicative. More expressive than a standard chassis should be.
**Eyes:** Very much someone home. Tracks with intention.
**Movement:** Fluid, quiet, and carrying the weight of decisions.

**Stress Responses:**
**Stress Tell:** Fur along the chassis seams rises.
**Instinct:** Psyniscience — assess the warp-state of the immediate environment first.
...
- Full cyber-mastiff chassis conversion: Voluntary. Quadruped form, armoured plating, sensory augments. Psyker integration was unplanned but stable.
- Warp-burn marks at augment interfaces: Present at conversion. Stable per Damien's documentation. What they actually indicate is an open question.
