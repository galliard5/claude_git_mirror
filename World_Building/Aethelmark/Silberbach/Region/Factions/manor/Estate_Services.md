...
*Intake & pricing: [[The_Apothecary]] | Brewed by: [[Alric_Dain]] ([[Industrial_Shops]]) | Monitored by: [[Infirmary]]*

Three variants offered. All standard contracts include the reversion elixir unless permanence is explicitly signed for.
...
For genital-only and partial transformations this is an opt-in. For full transformation it is included automatically — see above. Reversion of reproductive conversion requires the partial reversion compound; consult Alric and Dr. Korr.

**Mental Regression Add-On** *(full transformation only)*
Optional. Reduces the patient's cognitive and instinctual state to that of the animal form — appetite, impulse, and perception become those of the beast. Speech, complex memory, and self-reflection are permanently lost.

*This procedure is one-way and irreversible. No reversion elixir or alchemical means can undo it.*
...
- Dr. Korr must be satisfied the patient is fully lucid and not acting under duress or temporary emotional crisis
- A second medical opinion is strongly preferred; Korr may refuse to proceed without one
- Any doubt → procedure postponed, not denied

Patients who complete this add-on are transitioned into the estate's animal care program and treated with the same standard of care as all residents.

---

## Reversion Services

*Available at: [[The_Apothecary]] | Clinical oversight: [[Infirmary]]*

Reversion elixirs are available off-shelf. A client does not need a prior estate transformation to purchase — but Dr. Selene Korr will ask questions.

**Standard Reversion**
Covers all estate-produced transformations. Brewed on a standard rotation by Alric. Kept behind the counter; not on open display.

**Partial Reversion**
Targeted system reversion — reverts specific aspects of a transformation while leaving others intact. Specialized compound; requires consultation with Alric and Dr. Korr before purchase. Not kept in standing stock.

**Emergency Reversion**
Accelerated dissolution. Higher cost, higher physical toll on the patient. Used when speed matters more than comfort. Clinical monitoring recommended during administration.

*Full or partial reversal of a transformation performed elsewhere requires assessment by Dr. Korr and Alric before a compound can be confirmed appropriate. Success rate varies by time elapsed since original transformation and the potion type originally used.*

---

## Medical & Surgical Services

*Location: [[Infirmary]] | Provider: [[Dr_Selene_Korr]]*

Dr. Korr's dual veterinary-human expertise allows her to treat conditions that standard physicians will not touch.

**General Medical Care**
Routine care, wound treatment, fever and infection management, recovery monitoring. Available to staff, residents, and clients in procedure recovery. The infirmary is equipped for both human and animal patients.

**Transformed-Body Medicine**
Conditions specific to partially or fully transformed residents: metabolic strain, joint failure, sensory overload, infections that present differently in non-standard anatomies, and complications arising from long-term transformation. Ongoing care is available for permanent residents.

**Cosmetic & Body Modification**
Surgical alterations to form, features, or function. Handled case-by-case; full consultation required. Reversibility is discussed and documented prior to any procedure.

**Surgical Body Modification & Gender Affirming Procedures**
Permanent anatomical alterations including castration, penectomy, clitorectomy, hysterectomy, gender nullification, and urethral rerouting. These procedures cannot be achieved via transformation potion — potions operate on a species-template model and cannot selectively modify or remove anatomy within a single form. Surgical precision is required.

*Consent & verification:* All procedures in this category are permanent and irreversible. A minimum of one full consultation is required prior to scheduling. Written consent signed in the presence of Dr. Korr and witnessed by Isalia or Lyra. Any concern about the patient's state of mind or the presence of external pressure → procedure postponed pending a second consultation, not denied outright.

---

## Breeding & Stud Services

*Location: [[Kennels_and_Stables]] | Coordinator: [[Silas_the_Obsidian_Stallion]]*

Breeding sessions take place in the private, soundproofed breeding suites and the supervised play area. Discretion is absolute.

**Canine Stud — Vorro**
Brindled mastiff, shoulders level with a man's chest. Regular stud for kennel clients and arranged sessions. Handled exclusively by kennel staff; not a free-roaming resident.

**Equine Stud — Silas**
Destrier stallion, transformed permanent resident. Coordinates the manor's equine breeding appointments. Professional, controlled, takes sessions seriously. Appointments arranged through the intake desk.

**Manticore Stud — Kael**
Miniature manticore, transformed permanent resident. Available for entertainment and breeding sessions by arrangement. Client-facing and performative; Kira handles scheduling.

**Surrogacy & Whelping**
Available for high-status clients requiring a surrogate. Terms negotiated individually with Isalia. Full medical oversight by Dr. Korr throughout.

**Open Breeding — Play Area**
Supervised group sessions in the kennel play area. Portal board sessions may be incorporated where applicable. Kennel staff present throughout; never unsupervised.
...
*Crafted by: [[Elowen_Vale]] ([[Industrial_Shops]]) | Available at: [[The_Apothecary]]*

**Speech-Enchantment Collars**
Available in leather, worked steel, and engraved brass. On/off toggle is staff-controlled, not wearer-controlled. Sample collars on display in the left-hand case at the Apothecary.

**Restraint Hardware**
Padded cuffs, leads, adjustment rings. Shares display case with the collar range.

**Portal Devices — Portal Panties System**
...
**Bespoke Commissions — Elowen Vale**
Unique items produced to client specification. Elowen prices her own work. Request logged at the counter; a consultation time is arranged. She does not receive clients in the workshop — she comes to the Apothecary's consultation alcove.

**Dr. Everhorn's Orgasm Stifling Clitoral Cages** *(import — Dr. Everhorn's Orgasm Denial Products, est. A&B 419)*
A commercial enchanted restraint. The cage seals itself around the clitoral glans on fitting; once seated, it cannot be removed by the wearer. The enchantment combines an orgasm-prevention field with a persistent arousal induction — the wearer is maintained in a state of continuous heat while orgasm is rendered impossible. The enchantment draws on the same restraining principles used in law enforcement binding, adapted here for genital application.

Sold off-shelf. No intake consultation required, though Selene may ask questions if the purchaser's intentions raise concern. Sized; Kira keeps a fitting reference card behind the counter. The product is positioned in the right-hand display case alongside other denial and restraint hardware.

*Note: Each cage ships with its own unique key. Keys cannot be duplicated — clients are advised at point of sale that the key is their responsibility, as no replacement can be issued. If the key is lost, removal requires a specialist enchanter; Elowen can disengage the cage's enchantment directly, though this is a service charge separate from the original purchase.*

**Other Import Stock**
Additional items sourced through Isalia's guild contacts in Silberbach and beyond. Stock arrives once or twice yearly during Isalia's guild trips. Unique pieces; no guaranteed repeat availability.

---

## Alchemy & Medical Compounds

*Produced by: [[Alric_Dain]] ([[Industrial_Shops]]) | Available at: [[The_Apothecary]]*

**Wound Salves & Recovery Compounds**
Standard care preparations. Available off-shelf. A card in the Apothecary display case references Dr. Korr for anything requiring clinical guidance.

**Fever Reducers**
Standard stock.

**Fertility Aids**
Select preparations. Available at the counter. Consultation recommended for extended use.

**Pain Management Preparations**
Used during and after procedures; also available for general purchase. Clinical use coordinated with Dr. Korr.
...
- Transformed clients retain full legal status and rights.
- Reversion elixir included in all standard contracts unless permanence is specified and signed for.
- All permanent procedures require written consent witnessed by Isalia or Lyra in addition to the attending specialist.
