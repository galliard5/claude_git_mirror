...
**Pre-scenario — transformation not yet begun**

*Establish exact day at session start. Update as days advance.*
...
|---|---|---|---|
| Sapient hound programme — Vauclair trial | Pre-scenario | Active | First volunteer not yet transformed. Bastier recruiting. Marenne running private 18-month assessment from first active duty date. |
| Varne's pass network | Ongoing | Background — gradual | Garrison aware, cannot prove clan involvement. No acute flashpoint. |
...
**Pre-scenario**
- Bastier drafts sapient hound proposal after three years of field observation. Submits to Marenne.
- Marenne approves with three written questions answered. Signs same week. Does not express enthusiasm publicly.
- Corvel commissioned to administer transformation potion. Reviews formula thoroughly. Notes two points where documentation is thinner than preferred.
- Marenne writes private condition into programme notes (not disclosed to Bastier): if sapient hound demonstrates measurable operational value within 18 months of first active duty, she will forward formal recommendation to Crown. 18-month clock not yet started.
- Player character approaches garrison recruiter.

---

### Maruvec Campaign — Active

**Day 1 of final pre-transformation week (Session 01)**
- Varre delivers official schedule: transformation end of week, donor decision due following morning.
- Isandar selects Brac as donor hound after three weeks of observation. Varre marks it.
- Varre discloses pack integration uncertainty — Renne is the question mark, kobold scent profile undocumented.
- Isandar tells parents (Kaz and Yara Quickclaw, Corders Lane). Both informed. Yara: "Come back after."
- First easy evening — full squad at mess together. Perrin's first real laugh.

**Day 2 of final pre-transformation week (Session 02 — ongoing)**
- Alchemist Severin Cault arrives. Meets all five squad members individually.
- Cault's disclosed count: nine administrations successful, one difficult (undisclosed prior preparation, irregular uptake), one lost (outpost site, arrest in fifth hour, cause unknown). Monitoring protocol adjusted.
- Dix absent all morning — found by Isandar on Longers Wharf closing arrangements with a dock contact. Returned and disclosed to Varre. Varre accepted, noted in ledger.
